...
_CN.RDD.DESCRIPTOR.INVARIANT_DIM = 256
_CN.RDD.DESCRIPTOR.EQUIVARIANT_DIM = 3

# Disentangled descriptor training losses
# Keep the auxiliary split branch weak enough to preserve the main descriptor quality.
_CN.RDD.DESCRIPTOR.LOSS_W_EQUIVARIANT = 0.05
_CN.RDD.DESCRIPTOR.LOSS_W_DISENTANGLE = 0.005
_CN.RDD.DESCRIPTOR.LOSS_W_INV_ALIGN = 0.05
_CN.RDD.DESCRIPTOR.LOSS_W_INV_DIVERSE = 0.02
_CN.RDD.DESCRIPTOR.INV_NEG_MARGIN = 0.4
_CN.RDD.DESCRIPTOR.MAX_TRAIN_MATCHES = 2048
