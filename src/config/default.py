...
_CN.RDD.DESCRIPTOR.LOSS_W_EQUIVARIANT = 0.2
_CN.RDD.DESCRIPTOR.LOSS_W_DISENTANGLE = 0.02
_CN.RDD.DESCRIPTOR.LOSS_W_INV_ALIGN = 0.2
_CN.RDD.DESCRIPTOR.LOSS_W_INV_DIVERSE = 0.1
_CN.RDD.DESCRIPTOR.INV_NEG_MARGIN = 0.6
